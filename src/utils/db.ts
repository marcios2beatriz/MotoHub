...
<dyad-write path="src/components/ScheduleChatModal.tsx" description="Criando o componente ScheduleChatModal para chat direto de turno entre estabelecimento e motoboy">
"use client";
