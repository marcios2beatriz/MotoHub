// MotoHub Delivery - Atualização de tipos e sincronização com Supabase
      ...
      if (delData) {
        ...
        const mappedDeliveries: Delivery[] = delData.map(d => {
          ...
          return {
            ...
            status: finalStatus<dyad-write path="src/utils/db.ts" description="Completando o arquivo de banco de dados com todos os tipos e métodos de sincronização">
import { createClient } from '@supabase/supabase-js';
