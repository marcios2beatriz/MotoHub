  ...
  const loadData = () => {
    ...
    const riders = allUsers.filter(u => 
      estSchedules.some(s => {
        ...
        const riderOf<dyad-write path="src/pages/EstablishmentDashboard.tsx" description="Reescrevendo o arquivo EstablishmentDashboard.tsx por completo de forma limpa, robusta e sem cortes, removendo a tag aninhada que causava o erro de compilação.">
"use client";
