              ...
              <div>
                ...
                <div className="relative rounded-md shadow-sm">
                  ...
                  <input
                    type="text"
                    placeholder="Ex: 1042"
                    value={deliveryForm.<dyad-write path="src/pages/EstablishmentDashboard.tsx" description="Reescrevendo o arquivo EstablishmentDashboard.tsx por completo para garantir que esteja 100% íntegro e sem cortes">
"use client";
