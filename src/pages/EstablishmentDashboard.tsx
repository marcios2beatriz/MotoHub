                      ...
                      <div className="flex items-center space-x-3 self-end sm:self-center flex-shrink-0">
                        ...
                        <div className="flex items-center space-x-1">
                          <button
                            ...
                            title="<dyad-write path="src/pages/EstablishmentDashboard.tsx" description="Reescrevendo o EstablishmentDashboard por completo para garantir que o arquivo esteja íntegro e sem cortes, com a resolução ultra-robusta de estabelecimentos por escala ativa do motoboy">
"use client";
