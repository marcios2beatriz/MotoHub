...
<dyad-write path="src/pages/EstablishmentDashboard.tsx" description="Completando o arquivo EstablishmentDashboard.tsx com a lógica de fallback robusta e renderização completa do painel">
"use client";
