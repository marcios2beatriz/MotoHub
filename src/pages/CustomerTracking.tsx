      ...
      <div className="flex-1 relative min-h-[350px]">
        ...
        <div className="absolute bottom-4 left-4 right-4 z-20 max-w-md mx-auto bg-white rounded-2xl shadow-xl border border-slate-100 p-4 space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider<dyad-write path="src/pages/CustomerTracking.tsx" description="Completando o arquivo CustomerTracking.tsx com a geocodificação em cascata robusta e coordenadas corretas">
"use client";
