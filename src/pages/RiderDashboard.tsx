              ...
              return (
                <div key={s.id} className="p-4 bg-slate-50 rounded-xl border border-slate-100 space-y-3">
                  <div className="flex items-start justify-between gap-2">
                    <div>
                      <h4 className="font-bold text-slate-8<dyad-write path="src/pages/RiderDashboard.tsx" description="Reescrevendo o arquivo RiderDashboard.tsx completo para garantir que não haja cortes e que todos os chats funcionem perfeitamente">
"use client";
