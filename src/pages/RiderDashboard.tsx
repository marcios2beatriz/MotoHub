                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          {delivery.status === 'active' && (
                            <button
                              ...
                              title="Chat com<dyad-write path="src/pages/RiderDashboard.tsx" description="Reescrevendo o arquivo RiderDashboard.tsx completo com a integração do chat de turno e chat com o cliente separados">
"use client";
