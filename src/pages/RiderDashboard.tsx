        ...
        {activeTab === 'schedules' && (
          <div className="space-y-6">
            <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200 space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 bg-slate-50 p-3 rounded-lg border border-slate-200<dyad-write path="src/pages/RiderDashboard.tsx" description="Completing RiderDashboard.tsx with full observations buttons and modal integrations">
"use client";
