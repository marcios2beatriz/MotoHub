...
import { db, User, Schedule, Delivery, Notification } from '../utils/db';
import { 
  Bike, 
  LogOut, 
  Clock, 
...
export default function RiderDashboard() {
  ...
  const loadData = () => {
    ...
    const todayStr = db<dyad-write path="src/pages/RiderDashboard.tsx" description="Restoring the tabbed layout for the Rider Dashboard, including Dashboard, Escalas, Corridas (with direct delivery creation), and Notificações.">
"use client";
